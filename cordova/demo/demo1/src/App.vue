<template>
    <div>
        ...
        <button style="width:200px;height:40px;background: orange;" @click="openCarma">take photo</button>
        <button style="width:200px;height:40px;background: orange;" @click="openCarma">take photo</button>
        ...
        methods: {
            ...
            openCarma: function (sourceType) {
                ...
                function onSuccess(imageData) {
                    self.imageCapture = "data:image/jpeg;base64," + imageData;
                    alert('self.imageCapture')
                }
